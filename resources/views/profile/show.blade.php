          ...
          <div class="row justify-content-center">
              <div class="col-md-8">
                  <div class="card shadow-lg">
                      <div class="card-body">
                          <!-- Menempatkan Avatar di Tengah -->
                          <div class="text-center">
                              <!-- Title for the profile -->
                              <h3 class="fw-bold">PROFILE</h3> <!-- Added title above image -->
                              <div class="avatar" style="margin-bottom: 3cm; display:inline;">
                                  <img
                                      src="{{ asset('lite/assets/img/profillayanan.jpg') }}"
                                      alt="image profile"
                                      class="avatar-img rounded-circle"
                          ...
                          <table class="table table-borderless">
                              <tbody>
                                  ...
                                  <tr>
                                      <th scope="row" class="fw-bold">Email Terverifikasi</th>
                                      <td>{{ $user->email_verified_at ? $user->email_verified_at->format('d M Y H:i') : 'Belum Terverifikasi' }}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row" class="fw-bold">Tanggal Dibuat</th>
                                      <td>{{ $user->created_at->format('d M Y H:i') }}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row" class="fw-bold">Tanggal Terakhir Diperbarui</th>
